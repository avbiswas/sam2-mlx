...
def main() -> None:
    parser = argparse.ArgumentParser(description="Quantize/evaluate the SAM2.1 small MLX checkpoint.")
    ...
    parser.add_argument("--report", type=Path, default=ROOT / "outputs/benchmarks/quantization_small.json")
    ...
    for variant in args.variants:
        ...
        for recipe in recipes:
            ...
            output = args.output_dir / f"sam2.1_hiera_small_image_segmenter_{suffix}.safetensors"
